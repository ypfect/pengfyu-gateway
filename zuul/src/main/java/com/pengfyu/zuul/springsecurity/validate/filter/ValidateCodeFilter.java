 ...
 * 
 */
package com.pengfyu.zuul.springsecurity.validate.filter;

import com.pengfyu.zuul.common.ValidateCodeException;
import com.pengfyu.zuul.securityuse.GatewayAuthenticationFailureHandler;
...
import com.pengfyu.zuul.springsecurity.validate.ValidateCodeType;
...
public class ValidateCodeFilter extends OncePerRequestFilter implements InitializingBean {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
		...
		if (type != null) {
			logger.info("validating (" + request.getRequestURI() + ")code, codeType is." + type);
			try {
